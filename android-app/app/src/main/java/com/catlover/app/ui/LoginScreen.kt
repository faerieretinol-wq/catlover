...
import com.catlover.app.network.LoginRequest
...
@Composable
fun LoginScreen(onLoggedIn: () -> Unit, onBackToRegister: () -> Unit, onForgotPassword: () -> Unit = {}) {
            ...
            GlassCard {
                Column(
                    ...
                    TextButton(onClick = { onBackToRegister() }) {
                        Text(stringResource(R.string.action_register), color = Color.White.copy(0.7f))
                    }
